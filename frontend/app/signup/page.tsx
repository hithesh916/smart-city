...
export default function SignupPage() {
    ...
    const handleSignup = async (e: React.FormEvent) => {
        ...
        if (error) {
            ...
            // Create Profile in Database table? 
            // Supabase triggers are better for this, but could do it manually via API call if needed.
        ...
        <div className="flex items-center justify-center min-h-screen bg-muted/20">
            <Card className="w-full max-w-md shadow-lg">
                <CardHeader className="space-y-1">
                    ...
                    <p className="text-sm text-muted-foreground text-center">Join the Smart City Dashboard</p>
                </CardHeader>
